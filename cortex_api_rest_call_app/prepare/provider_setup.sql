...
CREATE DATABASE IF NOT EXISTS cortex_api_rest_call_app;
CREATE SCHEMA IF NOT EXISTS cortex_api_rest_call_app.napp;
...
USE ROLE naspcs_role;
CREATE IMAGE REPOSITORY IF NOT EXISTS cortex_api_rest_call_app.napp.img_repo;
GRANT USAGE ON DATABASE cortex_api_rest_call_app TO ROLE nac;
GRANT USAGE ON SCHEMA cortex_api_rest_call_app.napp TO ROLE nac;
GRANT READ ON IMAGE REPOSITORY cortex_api_rest_call_app.napp.img_repo TO ROLE nac;
