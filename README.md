...
| [Cortex Agent: App Discovery](./cortex-agent-app-discovery/) | A Cortex Agent that helps consumers discover Native Apps available in the Snowflake Marketplace or already installed in their account. |
