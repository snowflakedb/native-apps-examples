...
CREATE DATABASE IF NOT EXISTS SONGS_CORTEX_DB;
CREATE SCHEMA IF NOT EXISTS SONGS_CORTEX_DB.SONGS_CORTEX_SCHEMA;
CREATE OR REPLACE TABLE SONGS_CORTEX_DB.SONGS_CORTEX_SCHEMA.SONGS_PROVIDER_DATA(
    track_name VARCHAR,
    ...
    in_song_charts INTEGER,
    song_streams INTEGER,
    danceability_percentage INTEGER
);
INSERT INTO SONGS_CORTEX_DB.SONGS_CORTEX_SCHEMA.SONGS_PROVIDER_DATA VALUES
